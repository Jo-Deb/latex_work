...
\begin{tikzpicture}[background rectangle/.style={fill=black}, show background rectangle]
	...
	\draw[color=white] (0, 1.15) node {$\text{\tiny A}$};
	\draw[color=white] (1, 1.15) node {$\text{\tiny B}$};
	\draw[color=white] (0, -2.15) node {$\text{\tiny C}$};
	\draw[color=white] (1, -2.15) node {$\text{\tiny D}$};
